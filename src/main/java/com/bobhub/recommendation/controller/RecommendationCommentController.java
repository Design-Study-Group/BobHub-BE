...
public class RecommendationCommentController {
  ...
  public ResponseEntity<RecommendationCommentResponseDto> createComment(
    ...
    RecommendationComment createdComment =
        commentService.createComment(recommendationId, userId, requestDto);
    return new ResponseEntity<>(
        new RecommendationCommentResponseDto(createdComment), HttpStatus.CREATED);
  }
